...
class SessionState(BaseModel):
    ...
    last_outcome: Literal["success", "failed", "accepted", "declined", "third_party", "tangent", "silence", "pending", "interest", "knowledge_q", "secondary_pitch", "slot_captured", "competitor_deflect", "competitor_bail", ""] = Field(default="", description="The outcome of the last agent's turn.")
